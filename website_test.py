...
with tab9:
    ...
    # 12:30 Bearish
    st.header("12:30 1hr Bearish Tail Candles")
    file_path = os.path.join(os.path.dirname(__file__), "12_30am_hourly_summary_data.csv")
    ...
    # 1:30 Bearish
    st.header("1:30 1hr Bearish Tail Candles")
    file_path = os.path.join(os.path.dirname(__file__), "1_30am_hourly_summary_data.csv")
    ...
    file_path = os.path.join(os.path.dirname(__file__), "2_30am_hourly_summary_data.csv")
    ...
    # 2:30 Bearish
    st.header("2:30 1hr Bearish Tail Candles")
    file_path = os.path.join(os.path.dirname(__file__), "2_30am_hourly_summary_data.csv")
